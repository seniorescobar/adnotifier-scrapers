...
import (
	...
	"github.com/seniorescobar/adnotifier-scrapers/nepremicnine"
...
type ScraperSuite struct {
	...
	scraper    *nepremicnine.Scraper
}

func (s *ScraperSuite) SetupTest() {
	s.httpClient = new(httpClient)
	s.scraper = nepremicnine.NewScraper(s.httpClient)
}
...
func (s *ScraperSuite) TestScrape_Success() {
	var (
		url      = "https://www.nepremicnine.net/vrhnika"
		expItems = []scrapers.Item{
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/borovnica-stanovanje_6366237/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/mala-ligojna-stanovanje_6398968/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/mala-ligojna-2-km-do-vrhnike-stanovanje_6379277/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/padez-stanovanje_6408016/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/velika-ligojna-16-stanovanje_6407232/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/vrhnika-stanovanje_6406629/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/vrhnika-janezova-vas-stanovanje_6406295/"},
			{URL: "https://www.nepremicnine.net/oglasi-oddaja/vrhnika-zelenica-stanovanje_6353671/"},
		}
	)

	f, err := os.Open(path.Join(testResources, "success.html.gz"))
...
func (s *ScraperSuite) TestScrape_ErrAttributeDoesNotExist() {
	f, err := os.Open(path.Join(testResources, "err-attr.html.gz"))
	s.Require().NoError(err)
	defer f.Close()
	...
	items, err := s.scraper.Scrape(context.Background(), "")
	s.IsType(nepremicnine.ErrAttributeDoesNotExist{}, unwrap(err))
	s.Nil(items)
